...
def parse_args():
    ...
    parser.add_argument('--infrequent_threshold', type=int, default=5)
    ...
    # model
    parser.add_argument('--model', type=str, default='l', choices=['n', 'g', 'm', 'l']) # n: NGCF, g: gcn, m: gcmc, l: lightgcn 
        ...
        for iter in range(1, args.n_epochs + 1):
            ...
            for batch_id in range(num_batches):
                ...
                if args.bl == 'N' or check_iter_condition == False:
                    ...
                    user_emb_ego, pos_emb_ego, neg_emb_ego, user_emb, pos_emb, neg_emb, pos_i_com = model(user, pos, neg)
                        
                    state = generate_controller_state(user_emb_ego, pos_emb_ego, neg_emb_ego, pos_i_com, args.norm, args.state)
...
if __name__ == '__main__':
    ...
    if args.data_name == 'c':
        ...
        args.user_filter = 150 #30 #15
        args.item_filter = 200 #40 #20
        args.batch_size = 5000  
