...
class MatrixFactorization(nn.Module):
    def __init__(self, num_users, num_items, args):
        ...
        self.item_embeddings = nn.Embedding(self.num_items + 1, args.dim).to(self.device)
        ...
        self.agg_item_embeddings = nn.Embedding(self.num_items + 1, args.dim).to(self.device)
    ...
    def predict(self, user_id):
        user_emb = self.agg_user_embeddings(user_id).data
